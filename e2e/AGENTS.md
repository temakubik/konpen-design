...
- `tests/`: broader user-level end-to-end coverage, including Vitest checks that intentionally span app/package/resource boundaries.
...
- E2E Vitest tests use Node APIs; do not add JSX/TSX, jsdom, or browser-component tests under `tests/`.
